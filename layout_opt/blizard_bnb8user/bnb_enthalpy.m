function [tr_best, c_best] = bnb_enthalpy(pairs,users,c,n, mdpts, params,tc)
...
[~,idx_best] = min(c(idx));
[tr1,n] = expand_tree(pairs(idx(idx_best),:),mdpts,n,0);
[cb, ~] = fincalc_enthalpy(tr1,n,params,tc,mdpts,pairs);
