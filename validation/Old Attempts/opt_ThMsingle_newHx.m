function err = opt_ThMsingle_newHx(hAs,d,LS,ThMn,idx)
...
T = 1;
for i = 1:n
    A = makeAsingle_newHx(c1(i,:),c2,c3(i,:),b,a(i,:));
...
e(3) = 10*rmse(xr(:,3),d.(strcat('T_HxIn',num2str(ThMn))));
e(4) = 10*rmse(xr(:,4),d.(strcat('T_HxOut',num2str(ThMn))));
